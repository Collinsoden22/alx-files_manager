...
delegateToCalls("yieldTo", false, "yieldTo", true, function(property) {
    throw new Error(
        this.toString() + " cannot yield to '" + valueToString$8(property) + "' since it was not yet invoked."
    );
});
...
function throwOnFalsyObject(object, property) {
    if (property && !object) {
        ...
        throw new Error("Trying to stub property '" + valueToString$9(property) + "' of " + type);
    }
}
...
var hasOwnProperty$5 = lib.prototypes.object.hasOwnProperty;
...
var valueToString$a = lib.valueToString;
...
function stub(object, property) {
    ...
    if (isNonExistentOwnProperty_1(object, property)) {
        throw new TypeError("Cannot stub non-existent own property " + valueToString$a(property));
    }
...
forEach$3(Object.keys(behavior), function(method) {
    if (
        hasOwnProperty$5(behavior, method) &&
        !hasOwnProperty$5(proto$1, method) &&
        method !== "create" &&
        method !== "withArgs" &&
        method !== "invoke"
    ) {
...
forEach$3(Object.keys(defaultBehaviors_1), function(method) {
    if (hasOwnProperty$5(defaultBehaviors_1, method) && !hasOwnProperty$5(proto$1, method)) {
...
var match$4 = samsam.createMatcher;


var deepEqual$5 = samsam.deepEqual;

var valueToString$b = lib.valueToString;

var every$4 = arrayProto$b.every;
...
function verifyMatcher(possibleMatcher, arg) {
    var isMatcher = match$4.isMatcher(possibleMatcher);
...
var mockExpectation = {
    ...
    create: function create(methodName) {
        var expectation = extend.nonEnum(stub_1.create(), mockExpectation);
    ...
    atLeast: function atLeast(num) {
        if (typeof num !== "number") {
            throw new TypeError("'" + valueToString$b(num) + "' is not number");
        }
    ...
    exactly: function exactly(num) {
        if (typeof num !== "number") {
            throw new TypeError("'" + valueToString$b(num) + "' is not a number");
        }
    ...
    verifyCallAllowed: function verifyCallAllowed(thisValue, args) {
        ...
        if ("expectedThis" in this && this.expectedThis !== thisValue) {
            mockExpectation.fail(
                this.method +
                    " called with " +
                    valueToString$b(thisValue) +
                    " as thisValue, expected " +
                    valueToString$b(this.expectedThis)
            );
        }
        ...
        forEach$4(
            ...
            function(expectedArgument, i) {
                ...
                if (!deepEqual$5(args[i], expectedArgument)) {
                    mockExpectation.fail(
                        this.method +
                            " received wrong arguments " +
                            format_1(args) +
    ...
    allowsCall: function allowsCall(thisValue, args) {
        ...
        return every$4(expectedArguments, function(expectedArgument, i) {
            if (!verifyMatcher(expectedArgument, _args[i])) {
                return false;
            }

            if (!deepEqual$5(_args[i], expectedArgument)) {
                return false;
            }
...
var deepEqual$6 = samsam.deepEqual;
...
var every$5 = arrayProto$c.every;
...
function arrayEquals(arr1, arr2, compareLength) {
    ...
    return every$5(arr1, function(element, i) {
        return deepEqual$6(arr2[i], element);
    });
}
...
},{"./index":9,"lolex":52}],8:[function(require,module,exports){
...
},{"@sinonjs/formatio":28}],9:[function(require,module,exports){
...
},{"../configure-logger":1,"../fake-xhr":11,"./format":8,"path-to-regexp":53}],10:[function(require,module,exports){
...
},{"../configure-logger":1,"../event":5,"./blob":10,"@sinonjs/text-encoding":46,"just-extend":50}],12:[function(require,module,exports){
...
},{"./prototypes/array":20}],14:[function(require,module,exports){
...
},{"./called-in-order":13,"./class-name":14,"./deprecated":15,"./every":16,"./function-name":17,"./order-by-first-call":19,"./prototypes":23,"./type-of":26,"./value-to-string":27}],19:[function(require,module,exports){
...
},{"./prototypes/array":20}],20:[function(require,module,exports){

var copyPrototype = require("./copy-prototype");

module.exports = copyPrototype(Array.prototype);

},{"./copy-prototype":21}],21:[function(require,module,exports){
...
},{"./copy-prototype":21}],23:[function(require,module,exports){
...
},{"./array":20,"./function":22,"./object":24,"./string":25}],24:[function(require,module,exports){

var copyPrototype = require("./copy-prototype");

module.exports = copyPrototype(Object.prototype);

},{"./copy-prototype":21}],25:[function(require,module,exports){

var copyPrototype = require("./copy-prototype");

module.exports = copyPrototype(String.prototype);

},{"./copy-prototype":21}],26:[function(require,module,exports){
...
},{"type-detect":54}],27:[function(require,module,exports){
...
},{"@sinonjs/commons":18,"@sinonjs/samsam":45}],29:[function(require,module,exports){
...
},{"./get-class":31,"./get-class-name":30,"./identical":32,"./is-arguments":33,"./is-date":34,"./is-element":35,"./is-map":36,"./is-nan":37,"./is-object":39,"./is-set":40,"./is-subset":41,"@sinonjs/commons":18}],30:[function(require,module,exports){
...
},{"@sinonjs/commons":18}],31:[function(require,module,exports){
...
},{"./is-nan":37,"./is-neg-zero":38}],33:[function(require,module,exports){
...
},{"./get-class":31}],34:[function(require,module,exports){
...
},{"@sinonjs/commons":18}],43:[function(require,module,exports){
...
},{"./deep-equal":29,"./get-class":31,"./is-date":34,"./is-set":40,"./is-subset":41,"./matcher":44,"@sinonjs/commons":18}],44:[function(require,module,exports){
...
},{"./deep-equal":29,"./iterable-to-string":42,"@sinonjs/commons":18,"lodash":51}],45:[function(require,module,exports){
...
},{"./deep-equal":29,"./identical":32,"./is-arguments":33,"./is-element":35,"./is-neg-zero":38,"./is-set":40,"./match":43,"./matcher":44}],46:[function(require,module,exports){
